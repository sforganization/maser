...
{							 
	...
	GPIO_EXTILineConfig(GPIO_PortSourceGPIOA, GPIO_PinSource12);  	//选择PA15所在的GPIO管脚用作外部中断线路EXIT12		
 
	EXTI_InitStructure.EXTI_Line = EXTI_Line12;	//外部线路EXIT12
...
{       
	...
	EXTI_ClearITPendingBit(EXTI_Line12);  //清除EXTI15线路挂起位         
}  
//处理红外键盘
//返回相应的键值
