...
unsigned char FPM10A_Search[11]={0x01,0x00,0x08,0x04,0x01,0x00,0x00,0x01,0x2C,0x00,0x3B}; //搜索指纹搜索范围0 - 299,使用BUFFER1中的特征码搜索
...
//       for(i=0;i<11;i++)
//           {
//    	      MYUSART_SendData(FPM10A_Search[i]);   
//   		   }
...
u8 PS_HandShake(u32 *PS_Addr)
{
	...
	for(i=0;i<10;i++)
    {		
        MYUSART_SendData(FPM10A_Get_Device[i]);
    }
